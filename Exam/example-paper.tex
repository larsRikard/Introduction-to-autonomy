...
\hypersetup{%
  pdftitle  = {Working Title - Fruit Picker Robot},
  pdfauthor = {8510},
...
\author[1]{8510}
\affil[1]{IMS, Vestfold, Norway, {\small\texttt{anonymous@usn.no}}}
...
\abstract{%
This research paper explores the idea of an autonomous ground vehicle that possesses the ability to harvest fruit, such as strawberries. An introductory, holistic approach is taken, thus social, economic, technical and ... are investigated and discussed.
